      ...
      <div class="form-container">
        ...
        <div class="right-container">
          <div class="right-inner-container">
            ...
            <input required type="text" id="nasc" name="nasc" placeholder="DD/MM/AAAA" OnKeyPress="formatar('##/##/####',this)" pattern="\d{2}/\d{2}/\d{4}" maxlength="10">
            <br><br>
            ...
            Celular <br>
            <input required type="text" id="tel" placeholder="(XX) XXXXX-XXXX" maxlength="14" OnKeyPress="formatar('(##)#####-####',this)" pattern="\(d{2})\d{5}-\d{4}">
            <br><br>

            Email <br>
            <input required type="text" id="emal" placeholder="email@email.com">
            <br><br>
