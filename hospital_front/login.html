  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <form class="formulario">
        ...
        <input type="submit" class="fadeIn fourth entrar" formaction="home.html" value="Entrar">
        <input type="submit" class="fadeIn fourth cadastrar" formaction="cadastro.html" value="Cadastrar">

      </form>

      <!-- Remind Passowrd -->
      <div id="formFooter">
        <a class="underlineHover" href="./esqueci_senha.html">Esqueci minha senha</a>
      </div>
    </div>
  </div>
</body>
